...
/**
 * created by alexandre. NB: this class was almost completely generated by android studio
 */
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            DatabaseHelper dbhelp = new DatabaseHelper(LoginActivity.this); //hope it works, lel
            SQLiteDatabase db = dbhelp.open();
            /*int id =  db.connect(mEmail, mPassword);
            if (id == -1)
                return false;
            ...
            try {
                if (!(cursor.moveToFirst()) || cursor.getCount() == 0) { //the cursor is empty, which means SQL query returned nothing.
                    ...
                    for (int i = 0; i < result.length; i++) {
                        result[i] = cursor.getString(i); // on rempli avec les resultats de la requete un tableau
                    }
                }
